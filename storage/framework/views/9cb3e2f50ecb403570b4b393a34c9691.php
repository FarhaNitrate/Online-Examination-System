        ...
        <div class="card login-form m-auto">
            <div class="card-body">
                ...
                <div class="card-text">                    
                    <?php if($errors->any()): ?>
                    <div>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert"><?php echo e($errors->first()); ?></div>
                    </div>
                    <?php endif; ?>
...
</html><?php /**PATH D:\Xampp\htdocs\Websites\student-management-system\resources\views/login.blade.php ENDPATH**/ ?>